    ...
    <div className='cartContainer'>
      { items.length > 0 ? 
        <div className='flex-content-sidebar'>
          <div className='cart flex-column content-el'>
            <div className='cartList'>
              { items.map(el => {
                let vehicle = el.item;
                return (
                  <div className='cartElem padding-10  border rounded flex-row'>
          ...
          <div className='flex-column sidebar-el'>
              <div className='flex-centered' style={{marginTop: '30px'}}>
                <span>{`Subtotal (${cartDetails.count} items): `}<b>${cartDetails.subtotal}</b></span>
              </div>
              <div className='flex-centered'>
